...
#define PIN_SWD             P14       // pin connected to SWDIO/TMS via 100R resistor
#define PIN_SWK             P15       // pin connected to SWCLK/TCK via 100R resistor
#define PIN_RST             P30       // pin connected to nRESET
#define PIN_TDO             P31       // pin connected to TDO via 100R resistor
#define PIN_TDI             P32       // pin connected to TDI via 100R resistor
#define PIN_TRST            P34       // pin connected to nTRST
#define PIN_RXD             P16       // pin connected to RXD via 470R resistor
#define PIN_TXD             P17       // pin connected to TXT via 470R resistor
...
#define INTERFACE_STR_2     'C','M','S','I','S','-','D','A','P',' ','v','1'
